...
(function () {
  ...
  angular
    .module('connectus.posts.controllers', [])
  ...
  function PostsController($scope) {
     ...
     */
    function activate() {
      console.log("POSTS CONTROLLER", vm);
      $scope.$watchCollection(function () { console.log("WATCH COLLECTION", $scope.posts); return $scope.posts; }, render);
